...
Vector3D Globals::viewEyeY( 1, 0, 1.5f );
Vector3D Globals::fov( 120, 80, .2f );

GLuint Globals::textures[JGH_MAX_TEXTURES];
...
float Globals::rotationAngle = 0.0;
Vector3D Globals::cameraLocation(0.0f, 0.0f, 0.0f);
Vector3D Globals::cameraDirection(0.0f, 0.0f, -1.0f);
